...
import { MEMORY_CATEGORIES } from '../../data/memoryTimeline';

/**
 * MemoryFilters — Tactical Filter & Search Bar for Memory Valley
 * Features:
 * - Category domain tabs (ALL, MILESTONES, PROJECTS, EXPERIMENTS, TOOLING) with dynamic counts
...
export function MemoryFilters({
  ...
  return (
    <section
      aria-label="Memory Timeline Filters and Search"
    ...
    >
      {/* Category Tabs */}
      <div className="flex flex-wrap items-center gap-2" role="tablist" aria-label="Filter timeline milestones by category">
      ...
      <div className="flex items-center gap-2">
        <div className="relative flex-1 lg:w-72">
          ...
          <input
            ...
            placeholder="SEARCH TIMELINE / YEAR..."
            aria-label="Search memory milestones by title, year, technology, or keywords"
